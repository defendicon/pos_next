...
class BrainWiseBranding(Document):
    ...
    def validate_signature(self, client_data):
        ...
        try:
            ...
            # Recalculate signature to verify integrity (prevent replay of old/tampered data)
    ...
    def log_tampering(self, details):
        ...
        # Avoid recursive save loop - use db_set
...
# Backward Compatibility Shims for API endpoints moved to pos_next.api.branding
